...
var Detail = (function () {
    function Detail(pt_detail_id, //primary key
        ...
        pt_detail_priority, pt_detail_task, pt_detail_assignee, pt_detail_description, pt_detail_deliverable, pt_detail_eststart, pt_detail_estend, pt_detail_actstart, pt_detail_actend, pt_detail_status, pt_detail_deleted, pt_detail_show, pt_detail_onhold, pt_detail_reason, pt_detail_progress, pt_detail_entrytype) {
        ...
        this.pt_detail_entrytype = pt_detail_entrytype;
    }
    return Detail;
}());
